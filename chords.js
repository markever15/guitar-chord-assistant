...
window.chordDatabase = {
    'C': {
        'Major': [
            ...
            { name: 'Echo Shape (Full)', desc: 'Echo shape with the G string fretted instead of open.', frets: [-1, 3, 2, 5, 5, 3], fingers: [-1, 2, 1, 4, 4, 3] },
            ...
            { name: 'Ring Shape (3rd Fret)', desc: 'A-shape barre with the high E string left open to ring.', frets: [-1, 3, 5, 5, 5, 0], fingers: [-1, 1, 2, 2, 2, 0] },
            { name: 'A Shape (3rd Fret)', desc: 'Full 5-string barre shape.', frets: [-1, 3, 5, 5, 5, 3], fingers: [-1, 1, 3, 3, 3, 1] },
            { name: 'E Shape (8th Fret)', desc: 'Full 6-string barre shape.', frets: [8, 10, 10, 9, 8, 8], fingers: [1, 3, 3, 2, 1, 1] },
            { name: 'Top Shape (8th Fret)', desc: 'E-shape barre with the high E string left open.', frets: [8, 10, 10, 9, 8, 0], fingers: [1, 3, 3, 2, 1, 0] },
            { name: 'Top Shape (Shell)', desc: 'Top shape with the low strings left out.', frets: [-1, -1, 10, 9, 8, 0], fingers: [-1, -1, 3, 2, 1, 0] },
            { name: 'Jangle Shape (8th Fret)', desc: 'E-shape barre with the G and high E strings left open.', frets: [8, 10, 10, 0, 8, 0], fingers: [1, 3, 3, 0, 2, 0] },
            { name: 'Jangle Shape (Shell)', desc: 'Jangle shape with the low strings left out.', frets: [-1, -1, 10, 0, 8, 0], fingers: [-1, -1, 2, 0, 1, 0] },
            { name: 'G Shape (5th Fret)', desc: 'G-shape barre, open on the high E string.', frets: [8, 7, 5, 5, 5, 0], fingers: [4, 3, 1, 1, 1, 0] },
            { name: 'Shell Shape (8th Fret)', desc: '4-string jazz shell voicing.', frets: [-1, -1, 10, 9, 8, 8], fingers: [-1, -1, 4, 3, 1, 2] },
        ...
        'm': [
            ...
            { name: 'A Shape m (3rd Fret)', desc: 'Full 5-string minor barre shape.', frets: [-1, 3, 5, 5, 4, 3], fingers: [-1, 1, 3, 3, 2, 1] },
            { name: 'Cluster Shape (5th Fret)', desc: 'Wide partial barre voicing.', frets: [8, 6, 5, 5, 8, 8], fingers: [3, 2, 1, 1, 4, 4] },
            { name: 'Cluster Shape (Open 5th)', desc: 'Cluster voicing with the open G string as the 5th.', frets: [8, 6, 5, 0, 8, 8], fingers: [3, 2, 1, 0, 4, 4] },
            { name: 'Bare Shape (Open 5th)', desc: 'Cluster shape with the D string left out.', frets: [8, 6, -1, 0, 8, 8], fingers: [2, 1, -1, 0, 3, 3] },
            { name: 'E Shape m (8th Fret)', desc: 'Full 6-string minor barre shape.', frets: [8, 10, 10, 8, 8, 8], fingers: [1, 3, 3, 1, 1, 1] },
            { name: 'Stretch Shape (8th Fret)', desc: 'E-shape barre with an extended high E string.', frets: [8, 10, 10, 8, 8, 11], fingers: [1, 3, 3, 1, 1, 4] },
            { name: 'Stretch Shape (Open 5th)', desc: 'Stretch shape with the open G string as the 5th.', frets: [8, 10, 10, 0, 8, 11], fingers: [1, 3, 3, 0, 2, 4] },
        ...
        'm7': [
            ...
            { name: 'D Shape m7 (No 5th)', desc: '4th string root jazz shell voicing.', frets: [8, 10, 8, 8, -1, 8], fingers: [1, 3, 1, 1, -1, 1] },
        ...
        '5': [
            ...
            { name: 'A5 Shape (3rd Fret)', desc: 'Rock power chord.', frets: [-1, 3, 5, 5, -1, -1], fingers: [-1, 1, 2, 2, -1, -1] },
            { name: 'Layered Shape (3rd Fret)', desc: 'A5 shape with the high E string added.', frets: [-1, 3, 5, 5, -1, 3], fingers: [-1, 1, 3, 3, -1, 1] },
            { name: 'E Shape 5', desc: '6th string root power chord.', frets: [8, 10, -1, -1, -1, -1], fingers: [1, 2, -1, -1, -1, -1] },
            { name: 'Split Shape (5th Fret)', desc: 'Power chord with the A string left out.', frets: [8, -1, 5, 5, 8, 8], fingers: [3, -1, 1, 1, 4, 4] },
            { name: 'Split Shape (Open 5th)', desc: 'Split shape with the open G string as the 5th.', frets: [8, -1, 5, 0, 8, 8], fingers: [2, -1, 1, 0, 3, 3] },
            { name: 'Sparse Shape (8th Fret)', desc: 'Power chord with the A and D strings left out.', frets: [8, -1, -1, 0, 8, 8], fingers: [1, -1, -1, 0, 2, 3] },
            { name: 'Full Barre (8th Fret)', desc: 'Full 6-string power chord barre.', frets: [8, 10, 10, 0, 8, 8], fingers: [1, 3, 3, 0, 2, 2] },
        ...
        '7': [
            ...
            { name: 'D Shape 7 (No 5th)', desc: '4th string root jazz shell voicing.', frets: [8, 10, 8, -1, -1, 0], fingers: [1, 3, 1, -1, -1, 0] },
        ...
        '6': [
            ...
            { name: 'Drone Shape (3rd Fret)', desc: 'Open G string as the 5th.', frets: [-1, 3, 5, 0, 5, 5], fingers: [-1, 1, 2, 0, 3, 3] },
            ...
            { name: 'Cluster Shape (8th Fret)', desc: '5-note voicing with the A string left open.', frets: [8, 0, 10, 9, 8, 8], fingers: [1, 0, 4, 3, 2, 2] },
            ...
            { name: 'Open Shape (High E)', desc: 'Open shape with the G string fretted instead of open.', frets: [8, 0, 10, 9, 8, 0], fingers: [1, 0, 4, 3, 2, 0] },
            ...
            { name: 'Barre Shape (10th Fret)', desc: 'A/D-string barre with the 6th voiced on the B string.', frets: [8, 10, 10, 0, 10, 0], fingers: [1, 2, 2, 0, 3, 0] },
        ...
        'maj7add11': [
            ...
            { name: 'Airy Shape (Wide)', desc: 'Open-string maj7add11 voicing.', frets: [8, 8, 10, 0, 0, 0], fingers: [1, 1, 3, 0, 0, 0] },
        ...
        'maj7add13': [
            ...
            { name: 'Open Shape (7th Fret)', desc: 'maj7add13 with open G, B and high E strings.', frets: [8, 7, 7, 0, 0, 0], fingers: [3, 1, 2, 0, 0, 0] },
            { name: 'Open Shape (7th Fret Wide)', desc: 'maj7add13 with open G and B strings.', frets: [8, 7, 7, 0, 0, 7], fingers: [4, 1, 2, 0, 0, 3] },
            { name: 'Full Shape (7th Fret)', desc: 'maj7add13 with open G and B strings, high root.', frets: [8, 7, 7, 0, 0, 8], fingers: [3, 1, 2, 0, 0, 4] },
        ...
        'aug': [
            { name: 'Caug Shape', desc: 'Standard augmented triad.', frets: [-1, 3, 2, 1, 1, -1], fingers: [-1, 4, 3, 1, 2, -1] },
            ...
            { name: 'Open Shape (1st Fret)', desc: 'Augmented triad with open high E string.', frets: [-1, 3, 2, 1, 1, 0], fingers: [-1, 4, 3, 1, 2, 0] },
            ...
            { name: 'Airy Shape (9th Fret)', desc: 'Augmented triad with open high E string.', frets: [-1, -1, 10, 9, 9, 0], fingers: [-1, -1, 3, 1, 2, 0] },
        ...
        'm9': [
            ...
            { name: 'E Shape m9 (No 5th)', desc: '6th string root jazz m9 shell.', frets: [8, 5, 8, 8, 8, -1], fingers: [2, 1, 3, 3, 3, -1] },
            { name: 'D Shape m9 (No 5th)', desc: '4th string root jazz m9 shell.', frets: [8, 10, 8, 8, -1, 10], fingers: [1, 2, 1, 1, -1, 3] },
        ...
        'm11': [
            ...
            { name: 'A Shape m11 (No 5th/9th)', desc: '5th string root jazz m11 shell.', frets: [8, 8, 8, 8, 8, 10], fingers: [1, 1, 1, 1, 1, 3] },
        ...
        'maj11': [
            ...
            { name: 'Airy Shape (8th Fret)', desc: 'Open-string maj11 voicing.', frets: [8, 8, 0, 0, 0, 0], fingers: [1, 2, 0, 0, 0, 0] },
        ...
        '13': [
            ...
            { name: 'D Shape 13 (No 5th/9th)', desc: '4th string root jazz 13th shell.', frets: [8, 7, 7, 7, 8, 6], fingers: [3, 2, 2, 2, 4, 1] }
        ],
        'm13': [
            { name: 'Cm13 Shape', desc: '', frets: [8, 0, 8, 8, 8, 10], fingers: [1, 0, 2, 2, 2, 3] },
            { name: 'A Shape m13 (No 5th/9th)', desc: '5th string root jazz m13 shell.', frets: [8, 0, 0, 8, 8, 6], fingers: [2, 0, 0, 3, 3, 1] },
            { name: 'D Shape m13 (No 5th/9th)', desc: '4th string root jazz m13 shell.', frets: [8, 5, 8, 8, 8, 5], fingers: [3, 1, 4, 4, 4, 1] }
        ],
        'maj13': [
        ...
        '7sus4': [
            ...
            { name: 'E Shape 7sus4 (No 5th)', desc: '6th string root jazz 7sus4 shell.', frets: [8, 8, 8, -1, 8, 6], fingers: [2, 2, 2, -1, 2, 1] },
            { name: 'D Shape 7sus4 (No 5th)', desc: '4th string root jazz 7sus4 shell.', frets: [8, -1, -1, 0, 6, 6], fingers: [3, -1, -1, 0, 1, 1] },
        ...
        '7b9': [
            ...
            { name: 'E Shape 7b9 (No 5th)', desc: '6th string root jazz 7b9 shell.', frets: [8, -1, 8, 6, 8, 0], fingers: [2, -1, 2, 1, 3, 0] },
        ...
        '7#9': [
            ...
            { name: 'D Shape 7#9 (No 5th/7th)', desc: '4th string root jazz 7#9 shell (Hendrix chord).', frets: [8, -1, 8, 8, 8, 0], fingers: [1, -1, 2, 3, 4, 0] },
        ...
        'm(maj7)': [
            ...
            { name: 'D Shape m(maj7) (No 5th)', desc: '4th string root jazz shell voicing.', frets: [8, -1, 9, 8, 8, 8], fingers: [1, -1, 2, 1, 1, 1] },
        ...
        'm(add9)': [
            ...
            { name: 'E Shape m(add9) (No 5th)', desc: '6th string root, no barre needed.', frets: [8, 5, -1, 8, 8, 8], fingers: [2, 1, -1, 3, 3, 3] },
    ...
    'D': {
        'Major': [
            ...
            { name: 'E Shape (10th, Open)', desc: 'E-shape barre with open A and D strings.', frets: [10, 0, 0, 11, 10, 10], fingers: [1, 0, 0, 4, 2, 3] },
        ...
        // 아래 폼들은 원래 '6/9'에 "Chromatic"이라는 이름으로 들어 있었으나, 반음 내린 자리가
        // 장3도(F#)를 단3도(F)로 바꿔버려 실제로 울리는 음이 D, F, A, B, E - 즉 Dm6/9였음.
        // 6/9 쪽에는 같은 폼의 F# 버전이 그대로 남아 있다.
        'm6/9': [
            { name: 'E Shape (8th Fret)', desc: '6th-string root, only the high E string open.', frets: [10, 8, 9, 9, 10, 0], fingers: [3, 1, 2, 2, 4, 0] },
            { name: 'E Shape (8th Fret) #2', desc: '6th-string root, only the high E string open.', frets: [10, 8, 9, 10, 10, 0], fingers: [3, 1, 2, 4, 4, 0] },
            { name: 'E Shape (9th, Open A/B/Top)', desc: '6th-string root, open A, B, and high E strings.', frets: [10, 0, 9, 10, 0, 0], fingers: [2, 0, 1, 3, 0, 0] },
            { name: 'E Shape (9th, Open A/Top)', desc: '6th-string root, open A and high E strings.', frets: [10, 0, 9, 10, 10, 0], fingers: [2, 0, 1, 3, 4, 0] },
            { name: 'E Shape (10th, Open D/B/Top)', desc: '6th-string root, open D, B, and high E strings.', frets: [10, 12, 0, 10, 0, 0], fingers: [1, 3, 0, 2, 0, 0] },
            { name: 'E Shape (10th, Open A/B/Top)', desc: '6th-string root, open A, B, and high E strings.', frets: [10, 0, 12, 10, 0, 0], fingers: [1, 0, 3, 2, 0, 0] },
            { name: 'E Shape (10th, Open A/D/Top)', desc: '6th-string root, open A, D, and high E strings.', frets: [10, 0, 0, 10, 12, 0], fingers: [1, 0, 0, 2, 3, 0] },
            { name: 'E Shape (10th, Open D/Top)', desc: '6th-string root, open D and high E strings.', frets: [10, 12, 0, 10, 12, 0], fingers: [1, 3, 0, 2, 4, 0] },
            { name: 'E Shape (10th, Open A/Top)', desc: '6th-string root, open A and high E strings.', frets: [10, 0, 12, 10, 12, 0], fingers: [1, 0, 3, 2, 4, 0] },
            { name: 'E Shape (10th Fret)', desc: '6th-string root, only the high E string open.', frets: [10, 12, 12, 10, 12, 0], fingers: [1, 2, 2, 1, 3, 0] },
            { name: 'E Shape (10th, Open A/D/B)', desc: '6th-string root, open A, D, and B strings.', frets: [10, 0, 0, 10, 0, 12], fingers: [1, 0, 0, 2, 0, 3] },
            { name: 'E Shape (10th, Open D/B)', desc: '6th-string root, open D and B strings.', frets: [10, 12, 0, 10, 0, 12], fingers: [1, 3, 0, 2, 0, 4] }
        ],
        'maj7sus4': [
